...
void ShaderColorLight::SetPointLightParameters(const Vect& pos, float r, const Vect& att, const Vect& amb, const Vect& dif, const Vect& sp, int pointNum)
{
...
void ShaderColorLight::SetSpotLightParameters(const Vect& pos, float r, const Vect& att, const Vect& dir, float spotExp, const Vect& amb, const Vect& dif, const Vect& sp, int spotNum)
{
...
void ShaderColorLight::SendFog(float start, float range, const Vect& color)
{
	Data_Fog df;
	df.FogStart = start;
	df.FogRange = range;
